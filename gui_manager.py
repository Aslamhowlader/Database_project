...
class ModernLoginApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Citizen Help Portal")
    ...
    def create_login_screen(self):
        ...
        tk.Label(branding_frame, text="Citizen Help Portal", font=self.FONTS['title'], bg=self.COLORS['primary'], fg='white').pack(pady=5)
        tk.Label(branding_frame, text="Government System", font=self.FONTS['body'], bg=self.COLORS['primary'], fg=self.COLORS['light_bg']).pack(pady=5)
